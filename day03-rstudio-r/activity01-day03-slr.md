...
``` r
value <- 2 + 5
#This is a simple calculation of 2 and 5

int_vect <- seq(1, 9)
#This is me and my sequence of numbers starting at 1 and going to 9
char_vect <- letters[1:17]
#This is a clever lil cheeky wat to get a vector of alphabetical characters

Da_length <- length(char_vect[5:17])
#This is checking the length of the vector AFTER D, We use the length function and start at the 5th position
```
...
-   In the R code chunk below titled `residual-histogram`, replace
